...
This README reflects the current scope of `Group_6.ipynb`. The notebook focuses on integrating RetailX data, running exploratory analytics, computing RFM metrics, and applying KMeans clustering. Association-rule mining, persona decks, and additional CSV exports are **not** part of the latest notebook run and are therefore no longer listed as deliverables here.
